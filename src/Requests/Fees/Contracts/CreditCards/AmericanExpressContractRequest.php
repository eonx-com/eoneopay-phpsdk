...
class AmericanExpressContractRequest extends ContractRequest
{
    /**
     * Construct American Express fee contract request.
     *
    ...
    public function __construct(?array $data = null)
    {
        parent::__construct(\array_merge($data ?? [], [
            'group' => self::GROUP_CREDIT_CARD_AMERICAN_EXPRESS
        ]));
    }
}
